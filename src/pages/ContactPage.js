        ...
        return(<div>
            ...
            <Content >
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Button className="d-inline-block" varient="primary" type="submit" disabled={this.state.disabled}>Submit</Button>


                    {this.state.emailSent ===true && <p className="d-inline success-msg ml-3">Email Sent</p>}
                    {this.state.emailSent ===false && <p className="d-inline err-msg ml-3">Email Not Sent</p>}
